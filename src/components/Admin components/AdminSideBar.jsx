  ...
  return (
    ...
    <div className={sidebarOpen ? "slideIn AdminSidebarWrapper d-flex flex-column" : "AdminSidebarWrapper d-flex flex-column" }>
      ...
      <div className="AdminSideBarLinks d-flex flex-column align-items-center justify-content-center ">
        <Link to="/admin/dashboard" className="d-flex flex-column align-items-center justify-content-center AdminActiveClass">
          <img src={Dashboard} alt="daboard" />
          <span>Dashboard</span>
        </Link>
        <Link to="/admin/properties" className="d-flex flex-column align-items-center justify-content-center">
          <img src={AllProp} alt="allprop" />
          <span>All Properties</span>
        </Link>
        <Link to="/admin/add" className="d-flex flex-column align-items-center justify-content-center">
          <img src={Addnew} alt="daboard" />
          <span>Add New Property</span>
        </Link>
        <Link to="/admin/inspection" className="d-flex flex-column align-items-center justify-content-center">
        <img src= {Addnew} alt="daboard" />
